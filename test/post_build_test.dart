...
// This test is only run locally, not in CI, because it is failing in CI for
// unknown reasons. This needs to be investigated.
  ...
  group(
    ...
    () {
      ...
      final File portableArchive = File(
        Platform.isLinux
            ? linuxPortableArchivePath
            : windowsPortableArchivePath,
      );
